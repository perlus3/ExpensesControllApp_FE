...
import { DetailsTableView } from '../components/views/DetailsTableView';
...
import { SendResetPasswordLink } from '../components/reset-password/SendResetPasswordLink';
  ...
  return (
    <Routes>
      ...
      <Route element={<PrivateRoutes />}>
        ...
        <Route path="/details/:id" element={<DetailsTableView />} />
